...
| R3 | **Ledger con `amount` negativo o cero accidental** | Media | Crítico | `check (amount > 0)`. Server normaliza a positivo y aplica signo via event_type. Tests con cases negativos + cero. |
