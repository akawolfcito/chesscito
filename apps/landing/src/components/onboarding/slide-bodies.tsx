...
function Heading({ headline, support }: { headline: string; support: string }) {
  return (
    <>
      <h1 className="text-2xl font-extrabold text-[#3a2600]">{headline}</h1>
      <Divider />
  ...
  return (
    <>
      ...
      <div className="flex w-full gap-3">
        <Pill icon={<ArtImage src={ICONS.learn} alt="" />} label={t("learnPill")} />
        <Pill icon={<ArtImage src={ICONS.play} alt="" />} label={t("playPill")} />
      </div>
    </>
  );
}
...
export function Slide2Body() {
  ...
  return (
    <>
      <AvatarWithFade src={assets.avatarSrc} alt="" />
      <ArtImage src={assets.titleSrc} alt="21-Day Mind Challenge" className="h-16 w-full" />
      <Heading headline={t("headline")} support={t("support")} />
      <Pill
...
export function Slide3Body() {
  ...
  return (
    <>
      <AvatarWithFade src={assets.avatarSrc} alt="" />
      <ArtImage src={assets.titleSrc} alt="Play Chess Arena" className="h-16 w-full" />
      <Heading headline={t("headline")} support={t("support")} />
      <div className="flex w-full gap-3">
        <Pill icon={<ArtImage src={ICONS.savedGames} alt="" />} label={t("savedGamesPill")} />
        <Pill icon={<ArtImage src={ICONS.coachPro} alt="" />} label={t("coachProPill")} />
      </div>
      <Pill icon={<ArtImage src={ICONS.pro} alt="" />} label={t("proPill")} tone="gold" />
    </>
  );
}
...
export function Slide4Body() {
  ...
  return (
    <>
      <AvatarWithFade src={assets.avatarSrc} alt="" />
      <h1 className="text-2xl font-extrabold text-[#3a2600]">{t("headline")}</h1>
      <Divider />
      ...
      <div className="flex w-full items-center justify-between gap-2 rounded-xl bg-[#fbf1d6] px-4 py-2 text-xs text-[#5a4520]">
        <span>
          <ArtImage src={ICONS.seasonPass} alt="" className="mr-1 inline-block h-4 w-4" />
          {t("seasonPassLabel")} {t("seasonPassPrice")}
        </span>
        <span>
          <ArtImage src={ICONS.pro} alt="" className="mr-1 inline-block h-4 w-4" />
