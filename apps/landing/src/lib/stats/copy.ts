...
const EN: StatsCopy = {
  ...
  temporarilyUnavailable: "Temporarily unavailable while this public snapshot is protected.",
  total: "Total",
...
const ES: StatsCopy = {
  ...
  temporarilyUnavailable: "No disponible temporalmente mientras protegemos este snapshot público.",
  total: "Total",
