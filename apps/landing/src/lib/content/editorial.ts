...
export const LANDING_COPY = {
  ...
  problem: {
    ...
    claims: [
      {
        icon: "coach" as const,
        label: "They strengthen with mindful repetition, not brute effort.",
      },
      {
        icon: "star" as const,
  ...
  howItWorks: {
    ...
    steps: [
      { label: "LEARN", body: "Here's how the piece moves. Simple. Clear. No pressure." },
  ...
  capabilities: {
    ...
    items: [
      { icon: "crosshair" as const, label: "Sustained attention", body: "Focus that holds up against distractions." },
      { icon: "star" as const, label: "Visual memory", body: "Reading and remembering the board as a pattern." },
      { icon: "move" as const, label: "Planning", body: "Thinking several steps ahead before moving." },
      { icon: "refresh" as const, label: "Pattern recognition", body: "Seeing the familiar in the new." },
      { icon: "crown" as const, label: "Decision-making", body: "Choosing under simple constraints." },
    ],
  },
    ...
    cards: [
      {
        ...
        body: "For anyone curious about chess. Short, visual challenges make each session easy to start.",
      },
      {
        title: "Families",
        body: "A simple routine to share a few minutes of play instead of endless scrolling.",
      },
      {
        title: "Younger learners, with guidance",
        body: "A friendly way to learn when shared with a parent, coach, or mentor.",
      },
      {
  ...
  plans: {
    ...
    complement: "You can also try the coach with Coach Credits from $0.05.",
  },
