...
const messages = {
  ...
  DUEL_COPY: {
    ...en.DUEL_COPY,
    opponentCardTitle: "Un amigo",
    opponentCardHint: "Comparte un enlace y juega",

    setupTitle: "Partida con un amigo",
    setupClockLabel: "Tiempo para cada uno",
    ...
    invitingShare: "Compartir enlace",
    invitingCopy: "Copiar enlace",
    invitingCopied: "Enlace copiado",
    invitingExpiry: "El enlace sirve por una hora.",

    invitedTitle: "{name} quiere jugar",
    invitedTitleAnonymous: "Te invitaron a jugar",
    invitedBody: "Toma el asiento libre y la partida arranca al toque.",
    invitedJoin: "Entrar a la partida",
    invitedJoining: "Tomando tu asiento...",
    ...
    wonResign: "Tu rival se rindió. Ganaste.",
    lostResign: "Te rendiste.",
    wonTimeout: "A tu rival se le acabó el tiempo. Ganaste.",
    lostTimeout: "Se te acabó el tiempo.",
    drawStalemate: "Tablas por ahogado.",
    drawInsufficient: "Tablas. Ninguno puede dar mate.",
    drawRepetition: "Tablas por repetición.",
    drawFiftyMove: "Tablas por la regla de las cincuenta jugadas.",
    endedNeutral: "La partida terminó.",
    expiredTitle: "Nadie contestó",
    expiredBody: "Esta invitación se venció. No se perdió nada.",
    missingTitle: "Este duelo no existe",
    missingBody: "El enlace puede estar mal, o la partida ya se borró.",

    resign: "Rendirme",
    resignConfirmTitle: "¿Rendirte en esta partida?",
    resignConfirmBody: "Gana tu rival.",
    resignConfirm: "Rendirme",
    resignCancel: "Seguir jugando",
    backToPlay: "Volver a Jugar",

    noticeIllegalMove: "Esa jugada no es legal acá.",
    noticeNotYourTurn: "Todavía no es tu turno.",
    noticeVersionConflict: "Tu rival movió primero. Este es el tablero real.",
    noticeSeatTaken: "Alguien tomó el asiento antes que vos.",
    noticeExpired: "Esta partida ya terminó.",
    noticeNetwork: "Sin conexión. Volviendo a mirar el tablero.",
    noticeUnavailable: "Algo salió mal. Probá de nuevo.",
  },
  ARENA_COPY: {
    ...en.ARENA_COPY,
    title: "DUELO",
  ...
  MINIGAMES_COPY: {
    ...
    comingSoonLabel: "Pronto",
    viewAll: "Ver todos",
    viewAllAria: "Ver todos los mini-juegos",
    libraryTitle: "Mini-juegos",
    libraryBack: "Volver",
    libraryCompleted: "Completado",
    todayFormat: "{done}/{total} hoy",
    refillFormat: "{hours}h",
    refillAria: "Nuevos desafíos en unas {hours} horas",
    libraryToday: "Disponibles hoy",
    libraryDone: "Completados",
    libraryUpcoming: "Hay más desafíos en camino",
  ...
  PLAY_HUB_COPY: {
    ...
    playPathPlayLabel: "Duelo",
    playPathPlayAriaLabel: "Duelo: elegí tu rival",
    arenaLabel: "DUELO",
    arenaAriaLabel: "Duelo: elegí tu rival y jugá una partida completa",
