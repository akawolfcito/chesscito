...
const messages = {
  ...
  MINIGAMES_COPY: {
    ...
    allClearBody: "Puedes volver a jugar cualquiera desde la biblioteca.",
    viewAll: "Ver todos",
    viewAllAria: "Ver todos los mini-juegos",
    libraryTitle: "Mini-juegos",
    libraryBack: "Volver",
    libraryCompleted: "Completado",
    progressFormat: "{done}/{total} completados",
    progressAria: "{done} de {total} mini-juegos completados",
