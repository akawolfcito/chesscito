...
export const ACCEPTED_TOKENS = [
  ...
  // Task 1, 2026-07-02 — cUSD renamed on-chain to Mento Dollar/USDm.
  ...
  { symbol: "cUSD", address: "0x765DE816845861e75A25fCA122bb6898B8B1282a" as const, decimals: 18, permitVersion: "3" },
] as const;
