...
const COPY = PITCH_A_COPY.scenes.arena;
const LIGHT = PITCH_THEME.light;

/**
 * v3.2 — Light editorial warm.
 *
 * Arena progression. Phone protagonista on the right (mirror of
 * CapabilityShow which kept phone-left). Badge "ARENA" + serif
 * title with cognac italic on "sube el reto." + 3 light pills
 * (IA / Ritmo propio / Práctica).
 */
